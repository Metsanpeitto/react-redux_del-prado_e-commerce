...
const uso = (
  <div className="card-body">
    <p>
      Introducción Las condiciones que siguen, regulan el uso de la página web
      https://waldenbergInc.com titularidad de Waldenberg, S.A., que ésta pone a
      disposición de los usuarios de Internet y cuyo acceso es gratuito salvo en
      lo relativo al coste de la conexión a través de la red de
      telecomunicaciones suministrada por el proveedor de acceso contratado por
      los usuarios. Aceptación La utilización de https://waldenbergInc.com
      atribuye la condición de usuario e implica la aceptación de todas las
      condiciones y términos de uso incluidos en el presente apartado. El
      usuario debe leer atentamente estas condiciones en cada una de las
      ocasiones en que se proponga utilizar la página web, ya que pueden sufrir
      modificaciones. La información, software, o productos y servicios y
      contenidos de https://waldenbergInc.com pueden contener inexactitudes o
      errores tipográficos. Algunos servicios accesibles para los usuarios a
      través de https://waldenbergInc.com pueden estar sometidos a condiciones
      particulares que, en su caso, sustituirán, completarán y/o modificarán las
      presentes condiciones y que deberán ser aceptadas por el usuario antes de
      iniciar la prestación del servicio correspondiente. Waldenberg se reserva
      la facultad de modificar unilateralmente las condiciones y términos de uso
      de https://waldenbergInc.com. Cualquier cambio en este sentido se
      publicará de forma visible en la página web de manera que pueda ser
      conocido por el usuario antes de la visita a la misma. Obligaciones del
      usuario Obligación de hacer uso correcto de la página web Las condiciones
      de acceso y uso de https://waldenbergInc.com están supeditadas a la
      legalidad vigente y a los principios de buena fe y uso lícito por parte
      del usuario de la página quedando prohibido, con carácter general,
      cualquier tipo de actuación en perjuicio de Waldenberg y contraria a lo
      dispuesto en ellas. El usuario se compromete a utilizar la página web sin
      incurrir en actividades que puedan ser consideradas ilícitas o ilegales,
      que infrinjan los derechos de Waldenberg o de terceros, o que puedan
      dañar, inutilizar, sobrecargar o deteriorar la página o impedir la normal
      utilización de la misma por parte de otros usuarios. Solicitud de
      contenidos El usuario deberá abstenerse de realizar solicitudes de
      contenidos ofrecidos a través de la página web https://waldenbergInc.com
      utilizando medios o procedimientos distintos de los que se hayan puesto a
      su disposición, distintos de los que se hayan indicado en ella o distintos
      de los que se empleen habitualmente en Internet y siempre que los mismos
      no entrañen un riesgo de inutilización de la página web y sus contenidos.
      Prohibiciones Queda prohibido el uso de https://waldenbergInc.com con
      fines ilegales o no autorizados, en concreto y sin carácter taxativo:
      Cualquier forma de violación de los derechos de terceros (derecho a la
      intimidad, derecho a la propia imagen, derechos de propiedad intelectual e
      industrial...). Realizar, usando los contenidos de
      https://waldenbergInc.com, cualquier tipo de publicidad como envío de
      correos electrónicos no solicitados (spam) o comunicación similar.
      Introducir virus informáticos, archivos defectuosos o cualquier otros
      software o programa informático que pueda provocar daños o alteraciones no
      autorizadas de los contenidos o sistemas accesibles a través de
      https://waldenbergInc.com. Propiedad intelectual e industrial La
      información que aparece en https://waldenbergInc.com es la vigente en la
      fecha de su última actualización. Waldenberg se reserva el derecho a
      actualizar, modificar o eliminar unilateralmente y sin previo aviso dicha
      información. Todos los contenidos que se muestran en la página (textos,
      gráficos, fotografías, logos diseños, códigos fuente, contenidos
      audiovisuales o sonoros...) están sujetos a derechos de propiedad
      intelectual y/o industrial de los que es titular Waldenberg o terceros que
      han autorizado su inclusión en ella. Cualquier explotación de todo o parte
      del contenido de la página, efectuado de cualquier forma o por cualquier
      medio, electrónico, mecánico u otro, están estrictamente prohibidos. La
      infracción de estos derechos puede dar lugar a la iniciación de
      procedimientos judiciales, civiles o penales. Protección de datos Todos
      los datos personales facilitados a través de https://waldenbergInc.com
      para realizar cualquier tipo de solicitud, sugerencia o similares son
      recogidos mediante formularios que disponen de las correspondientes
      cláusulas según lo establecido en el Reglamento UE 2016/679, de 27 de
      abril, General de Protección de Datos y la Ley Orgánica 3/2018, de 5 de
      diciembre, de Protección de Datos y garantía de los derechos digitales.
      Cookies Waldenberg podrá utilizar cookies durante el acceso a
      https://waldenbergInc.com. Las cookies son procedimientos automáticos de
      recogida de información relativa a las preferencias determinadas por un
      usuario durante su visita a una determinada página web. Esta información
      se registra en pequeños archivos que son guardados en los equipos
      informáticos del usuario correspondiente de forma imperceptible. Cada vez
      que el usuario vuelve a acceder a la página web en cuestión, estos
      archivos se activan automáticamente de manera que se configura la página
      con las preferencias señaladas en anteriores visitas. En definitiva, las
      cookies son ficheros de información personal alojados en el propio
      terminal del usuario y asociados inequívocamente a este terminal. Las
      cookies no pueden leer los archivos cookie creados por otros sitios web.
      El usuario tiene la posibilidad de configurar su programa navegador de
      manera que se impida la creación de archivos cookie o se advierta del
      momento en que esto ocurre. La página web https://waldenbergInc.com es
      accesible sin necesidad de que estén activadas las opciones referentes a
      los archivos cookie, si bien pueden impedir el correcto funcionamiento de
      mecanismos de seguridad para servicios exclusivos o determinados servicios
      que requieren de una mayor seguridad. Por norma general, la finalidad de
      los archivos cookie de la página web es la de facilitar la navegación del
      usuario. Hiperenlaces El usuario que quiera introducir enlaces desde sus
      propias páginas web a https://waldenbergInc.com deberá cumplir con las
      condiciones que se detallan a continuación sin que el desconocimiento de
      las mismas evite las responsabilidades derivadas de la Ley: El enlace
      únicamente vinculará con la home page o página principal pero no podrá
      reproducirla de ninguna forma (inline links, copia de los textos,
      gráficos...) Quedará en todo caso prohibido, de acuerdo con la legislación
      aplicable y vigente en cada momento, establecer frames o marcos de
      cualquier tipo que envuelvan a esta página o permitan la visualización de
      los contenidos a través de direcciones de Internet distintas a las de la
      misma y, en cualquier caso, cuando se visualicen conjuntamente con
      contenidos ajenos a ella de forma que: (I) produzca, o pueda producir,
      error, confusión o engaño en los usuarios sobre la verdadera procedencia
      del servicio o contenidos; (II) suponga un acto de comparación o imitación
      desleal; (III) sirva para aprovechar la reputación de la marca y prestigio
      de Waldenberg; o (IV) de cualquier otra forma resulte prohibido por la
      legislación vigente. No se realizarán desde la página que introduce el
      enlace ningún tipo de manifestación falsa, inexacta o incorrecta sobre
      Waldenberg, sus empleados o sobre las actividades que desarrolla. En
      ningún caso, se expresará en la página donde se ubique el enlace que
      Waldenberg ha prestado su consentimiento para la inserción del mismo o
      que, de otra forma, patrocina, colabora, verifica o supervisa los
      servicios del remitente. Está prohibida la utilización de cualquier marca
      denominativa, gráfica o mixta o cualquier otro signo distintivo de
      Waldenberg dentro de la página del remitente salvo en los casos permitidos
      por la Ley o expresamente autorizados por Waldenberg y siempre que se
      permita, en estos casos, un enlace directo con la página web de Waldenberg
      en la forma establecida en esta cláusula. La página que establezca en
      enlace deberá cumplir fielmente con la Ley y no podrá en ningún caso
      ...
      (pornográficos, violentos, racistas, etc...); (ii) induzcan o puedan
      inducir en el Usuario la falsa concepción de que Waldenberg suscribe,
      respalda, se adhiere o de cualquier manera apoya, las ideas,
      manifestaciones o expresiones, lícitas o ilícitas, del remitente; (iii)
      resulten inapropiados o no pertinentes con la actividad de Waldenberg en
      atención al lugar, contenidos y temática de la página web del remitente.
      En cualquier caso, Waldenberg se reserva el derecho a prohibir los enlaces
      a https://waldenbergInc.com y a exigir su retirada cuando éstos no cumplan
      las condiciones exigidas en este apartado. Responsabilidad El usuario será
      el único responsable de las infracciones en que pueda incurrir o de los
      perjuicios que se puedan causar a terceros por la indebida o ilegítima
      utilización de la página web https://waldenbergInc.com. Waldenberg no será
      responsable de los posibles daños o perjuicios que se puedan derivar de
      interferencias, omisiones, interrupciones, virus informáticos, averías
      telefónicas o desconexiones en el funcionamiento operativo de los sistemas
      electrónicos o informáticos, motivadas por causas ajenas a la empresa, de
      los retrasos o bloqueos en el uso de dichos sistemas causados por
      deficiencias o sobrecargas de líneas telefónicas, sobrecargas en el
      sistema de Internet o en otros sistemas electrónicos. Waldenberg no
      garantiza la veracidad ni se responsabiliza de las consecuencias de
      pudieran derivarse de los errores en los contenidos proporcionados por
      terceros que pudieran aparecer en https://waldenbergInc.com. Del mismo
      modo, Waldenberg tampoco se responsabiliza de los contenidos, productos o
      servicios que puedan visualizarse mediante enlaces electrónicos (links),
      directa o indirectamente, a través de https://waldenbergInc.com, salvo en
      aquellos supuestos previstos en el artículo 17 de la Ley 34/2002, de 12 de
      julio, de Servicios de la Sociedad de la Información y Comercio
      Electrónico (LSSI). En caso de que un usuario considere que existe un
      sitio enlazado con contenidos ilícitos o inadecuados deberá ponerlos en
      conocimiento de Waldenberg siguiendo el procedimiento establecido en el
      apartado 10.7 de estas condiciones. Los enlaces no representan
      necesariamente la existencia de relación entre Waldenberg y los
      particulares o entidades titulares de las páginas a las que dan acceso ni
      la recomendación, promoción o identificación de Waldenberg con las
      manifestaciones, contenidos o servicios facilitados a través de ella.
      Waldenberg se reserva el derecho a retirar de modo unilateral y en
      cualquier momento los links que aparecen en http://www.Waldenberg.com/.
      Waldenberg no conoce los contenidos y servicios de los sitios enlazados y,
      por tanto, no se hace responsable por los daños producidos por la
      ilicitud, calidad, desactualización, indisponibilidad, error e inutilidad
      de los mismos ni por cualquier otro daño que no sea directamente imputable
      a ella. Waldenberg se exime de responsabilidad en cuanto a las "cookies"
      que terceros ajenos pudieran instalar en el disco duro del ordenador del
      usuario. Comunicaciones Para cualquier comunicación que fuera preciso
      efectuar deberá enviar un correo electrónico a lopd@Waldenberg.es o una
      comunicación escrita a: Waldenberg S.A. N.I.F: A-33093097 Castiello 145
      33690 Lugo de Llanera (Asturias) https://waldenbergInc.com El usuario
      acepta expresamente la utilización de correo electrónico como
      procedimiento válido para la remisión de comunicaciones.
    </p>
  </div>
);
