...
function (_React$Component) {
  (0, _inheritsLoose2.default)(StickyBox, _React$Component);
    ...
    _this.registerContainerRef = function (n) {
      ...
      if (n) {
        ...
        if (_this.scrollPane === window) {
          ...
          _this.rosp = new _resizeObserverPolyfill.default(_this.updateScrollPane);
        ...
        _this.ropn = new _resizeObserverPolyfill.default(_this.updateParentNode);

        _this.ropn.observe(_this.node.parentNode);

        _this.updateParentNode();

        _this.ron = new _resizeObserverPolyfill.default(_this.updateNode);
...
process.env.NODE_ENV !== "production" ? StickyBox.propTypes = {
  onChangeMode: _propTypes.default.func,
