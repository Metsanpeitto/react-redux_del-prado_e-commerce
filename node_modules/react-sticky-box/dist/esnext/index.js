    ...
    this.handleScroll = () => {
      ...
      if (scrollDelta > 0) {
        ...
        if (this.mode === "stickyTop") {
          this.offset = Math.max(0, this.scrollPaneOffset + this.latestScrollY - this.naturalTop + offsetTop);
        ...
        if (this.mode === "stickyBottom") {
          this.offset = Math.max(0, this.scrollPaneOffset + this.latestScrollY + this.viewPortHeight - (this.naturalTop + this.nodeHeight + offsetBottom));
