Arguments: 
  /usr/local/Cellar/node/12.5.0/bin/node /usr/local/bin/yarn login
...
Trace: 
  Error: canceled
      at Interface.<anonymous> (/usr/local/lib/node_modules/yarn/lib/cli.js:125850:13)
...
Lockfile: 
  ...
  lodash@^4.17.13, lodash@^4.17.4, lodash@^4.3.0:
    version "4.17.15"
