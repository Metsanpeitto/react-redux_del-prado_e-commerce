...
var _format = _interopRequireDefault(require("../source/format"));

var _templateFormatter = _interopRequireDefault(require("../source/template formatter"));

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { "default": obj }; }

describe("format", function () {
  it("should format phone numbers", function () {
    var formatter = (0, _templateFormatter["default"])('(xxx) xxx-xx-xx');

    var test_caret_position = function test_caret_position(digit_index, caret_in_formatted) {
      (0, _chai.expect)((0, _format["default"])('8005553535', digit_index, formatter)).to.deep.equal({
        text: '(800) 555-35-35',
  ...
  it('should autoconstruct template formatter from a template', function () {
    (0, _chai.expect)((0, _format["default"])('8005553535', 0, '(xxx) xxx-xx-xx')).to.deep.equal({
      text: '(800) 555-35-35',
      caret: 1
    });
  });
  it('should format value with no caret position', function () {
    (0, _chai.expect)((0, _format["default"])('8005553535', undefined, '(xxx) xxx-xx-xx')).to.deep.equal({
      text: '(800) 555-35-35',
      caret: 15
    });
  });
  it('should format value with no template preserving caret position', function () {
    (0, _chai.expect)((0, _format["default"])('8005553535', 2, // () => { text: '8005553535' }
