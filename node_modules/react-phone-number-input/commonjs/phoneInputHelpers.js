...
exports.getInitialParsedInput = getInitialParsedInput;
...
function migrateParsedInputForNewCountry(value, previous_country, new_country, metadata, preferNationalFormat) {
  ...
  if (!value) {
    if (preferNationalFormat) {
      ...
      return '+' + (0, _core.getCountryCallingCode)(new_country, metadata);
    }
  ...
  if (new_country) {
    ...
    if (value[0] === '+') {
      ...
      if (previous_country) {
        if ((0, _core.getCountryCallingCode)(new_country, metadata) === (0, _core.getCountryCallingCode)(previous_country, metadata)) {
          return value;
        } else {
          return "+".concat((0, _core.getCountryCallingCode)(new_country, metadata));
        }
      } else {
        var defaultValue = "+".concat((0, _core.getCountryCallingCode)(new_country, metadata)); // If `parsedInput`'s country calling code part is the same
...
function getInitialParsedInput(value, country, international, metadata) {
  ...
  if (!value && international && country) {
    return "+".concat((0, _core.getCountryCallingCode)(country, metadata));
  }
