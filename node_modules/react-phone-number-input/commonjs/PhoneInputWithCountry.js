...
function (_React$PureComponent) {
  ...
  function PhoneNumberInput_(props) {
    ...
    _defineProperty(_assertThisInitialized(_this), "onChange", function (_input) {
      ...
      var _parseInput = (0, _phoneInputHelpers.parseInput)(_input, _this.state.parsedInput, _this.state.country, defaultCountry, _this.state.countries, addInternationalOption, international, limitMaxLength, metadata),
    ...
    _this.state = {
      ...
      country: (0, _phoneInputHelpers.getPreSelectedCountry)(phoneNumber, _defaultCountry, countries || (0, _countries2.getCountries)(_metadata), _addInternationalOption, _metadata),
  ...
  _createClass(PhoneNumberInput_, [{
    ...
    value: function render() {
      ...
      var countrySelectOptions = useMemoCountrySelectOptions(function () {
        return (0, _countries2.sortCountryOptions)((0, _phoneInputHelpers.getCountrySelectOptions)(countries || (0, _countries2.getCountries)(metadata), labels, addInternationalOption), (0, _countries2.getSupportedCountryOptions)(countryOptionsOrder, metadata));
    ...
    value: function getDerivedStateFromProps(props, state) {
      ...
      if (newDefaultCountry !== prevDefaultCountry && !hasUserSelectedACountry && (!value && !newValue || international && value === (0, _phoneInputHelpers.getInitialParsedInput)(undefined, prevDefaultCountry, international, metadata) && value === (0, _phoneInputHelpers.getInitialParsedInput)(undefined, newDefaultCountry, international, metadata))) {
        return _objectSpread({}, newState, {
          country: (0, _countries2.isCountrySupportedWithError)(newDefaultCountry, metadata) ? newDefaultCountry : prevDefaultCountry,
...
function generateInitialParsedInput(value, phoneNumber, _ref) {
  ...
  return (0, _phoneInputHelpers.getInitialParsedInput)(value, defaultCountry, international, metadata);
}
