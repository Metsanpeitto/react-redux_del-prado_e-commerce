...
describe('phoneInputHelpers', function () {
  ...
  it('should migrate parsed input for new country', function () {
    ...
    (0, _phoneInputHelpers.migrateParsedInputForNewCountry)('', 'RU', 'US', _metadataMin["default"], true).should.equal(''); // Switching from "International" to a country
    ...
    (0, _phoneInputHelpers.migrateParsedInputForNewCountry)('8005553535', 'RU', 'US', _metadataMin["default"]).should.equal('8005553535'); // Switching from "International" to a country. Calling code not matches. Resets parsed input.

    (0, _phoneInputHelpers.migrateParsedInputForNewCountry)('+78005553535', null, 'US', _metadataMin["default"]).should.equal('+1'); // Switching from "International" to a country. Calling code matches. Doesn't reset parsed input.

    (0, _phoneInputHelpers.migrateParsedInputForNewCountry)('+12223333333', null, 'US', _metadataMin["default"]).should.equal('+12223333333'); // Switching countries. International number. Calling code doesn't match.

    (0, _phoneInputHelpers.migrateParsedInputForNewCountry)('+78005553535', 'RU', 'US', _metadataMin["default"]).should.equal('+1'); // Switching countries. International number. Calling code matches.

    (0, _phoneInputHelpers.migrateParsedInputForNewCountry)('+18005553535', 'CA', 'US', _metadataMin["default"]).should.equal('+18005553535'); // Switching countries. International number.
    ...
    (0, _phoneInputHelpers.migrateParsedInputForNewCountry)('+78005553535', null, 'US', _metadataMin["default"], true).should.equal(''); // Force international format. `parsedInput` is empty. From no country to a country.

    (0, _phoneInputHelpers.migrateParsedInputForNewCountry)(undefined, null, 'US', _metadataMin["default"], false).should.equal('+1'); // Force international format. `parsedInput` is not empty. From a country to a country with the same calling code.

    (0, _phoneInputHelpers.migrateParsedInputForNewCountry)('+1222', 'CA', 'US', _metadataMin["default"], false).should.equal('+1222'); // Force international format. `parsedInput` is not empty. From a country to a country with another calling code.

    (0, _phoneInputHelpers.migrateParsedInputForNewCountry)('+1222', 'CA', 'RU', _metadataMin["default"], false).should.equal('+7'); // Force international format. `parsedInput` is not empty. From no country to a country.

    (0, _phoneInputHelpers.migrateParsedInputForNewCountry)('+1222', null, 'US', _metadataMin["default"], false).should.equal('+1222');
  });
  ...
  it('should parse input', function () {
    (0, _phoneInputHelpers.parseInput)(undefined, undefined, 'RU', undefined, undefined, true, false, false, _metadataMin["default"]).should.deep.equal({
      input: undefined,
      country: 'RU',
      value: undefined
    });
    (0, _phoneInputHelpers.parseInput)('', undefined, undefined, undefined, undefined, true, false, false, _metadataMin["default"]).should.deep.equal({
      input: '',
      country: undefined,
      value: undefined
    });
    ...
    (0, _phoneInputHelpers.parseInput)('1213', undefined, undefined, undefined, undefined, true, false, false, _metadataMin["default"]).should.deep.equal({
      input: '+1213',
      country: undefined,
      value: '+1213'
    });
    ...
    (0, _phoneInputHelpers.parseInput)('213', undefined, 'US', undefined, undefined, true, false, false, _metadataMin["default"]).should.deep.equal({
      input: '213',
      country: 'US',
      value: '+1213'
    });
    (0, _phoneInputHelpers.parseInput)('+78005553535', undefined, 'US', undefined, undefined, true, false, false, _metadataMin["default"]).should.deep.equal({
      input: '+78005553535',
      country: 'RU',
      value: '+78005553535'
    }); // Won't reset an already selected country.

    (0, _phoneInputHelpers.parseInput)('+15555555555', undefined, 'US', undefined, undefined, true, false, false, _metadataMin["default"]).should.deep.equal({
      input: '+15555555555',
      country: 'US',
      value: '+15555555555'
    }); // `limitMaxLength`.

    (0, _phoneInputHelpers.parseInput)('21337342530', undefined, 'US', undefined, undefined, true, false, true, _metadataMin["default"]).should.deep.equal({
      input: '2133734253',
      country: 'US',
      value: '+12133734253'
    });
    (0, _phoneInputHelpers.parseInput)('+121337342530', undefined, 'US', undefined, undefined, true, false, true, _metadataMin["default"]).should.deep.equal({
      input: '+12133734253',
      country: 'US',
      value: '+12133734253'
    }); // This case is intentionally ignored to simplify the code.

    (0, _phoneInputHelpers.parseInput)('+121337342530', undefined, undefined, undefined, undefined, true, false, true, _metadataMin["default"]).should.deep.equal({
      // input: '+12133734253',
      // country: 'US',
      // value: '+12133734253'
      input: '+121337342530',
    ...
    (0, _phoneInputHelpers.parseInput)('', '+78005553535', 'RU', undefined, undefined, true, false, false, _metadataMin["default"]).should.deep.equal({
      input: '',
      country: undefined,
      value: undefined
    }); // Should reset the country if it has likely been automatically
    ...
    (0, _phoneInputHelpers.parseInput)('', '+78005553535', 'RU', 'US', undefined, true, false, false, _metadataMin["default"]).should.deep.equal({
      input: '',
      country: 'US',
      value: undefined
    ...
    (0, _phoneInputHelpers.parseInput)('', '+78005553535', 'RU', 'US', undefined, true, true, false, _metadataMin["default"]).should.deep.equal({
      input: '',
      country: undefined,
      value: undefined
    }); // Should reset the country if it has likely been automatically
    ...
    (0, _phoneInputHelpers.parseInput)('2', '+78005553535', 'RU', undefined, undefined, true, true, false, _metadataMin["default"]).should.deep.equal({
      input: '+2',
      country: undefined,
      value: '+2'
    });
  ...
  it('should get initial parsed input', function () {
    (0, _phoneInputHelpers.getInitialParsedInput)('+78005553535', 'RU', false, _metadataMin["default"]).should.equal('+78005553535');
    (0, _phoneInputHelpers.getInitialParsedInput)('+78005553535', 'RU', true, _metadataMin["default"]).should.equal('+78005553535');
    (0, _phoneInputHelpers.getInitialParsedInput)(undefined, 'RU', true, _metadataMin["default"]).should.equal('+7');
    expect((0, _phoneInputHelpers.getInitialParsedInput)(undefined, 'RU', false, _metadataMin["default"])).to.be.undefined;
    expect((0, _phoneInputHelpers.getInitialParsedInput)(undefined, undefined, false, _metadataMin["default"])).to.be.undefined;
  });
});
